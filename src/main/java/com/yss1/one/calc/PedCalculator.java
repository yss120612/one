...
private Date dfrom=Utils.makeDate(2000,9,1);

public Period getPedPeriod(List<Staj> stl) {
if (stl==null) return new Period(0,0,0);
return stCalc.getStajAll(getPedStaj(stl));
}


public List<Staj> getPedStaj(List<Staj> stl){
	float stavka;
