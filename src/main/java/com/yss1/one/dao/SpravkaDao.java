...
public class SpravkaDao {
	...
	public Long insertAndGetId(String dt,String snils, int ij, int koe, float otn) {
		pgDT.update("insert into public.spravka (vc_client,vc_ins,ts_q,pens,Igd,Rk,otn_zp) values ('"+ WebUtils.getLogin() + "','" + snils + "',TIMESTAMP '" + dt + "',0,"+ij+","+koe+","+otn+")");
